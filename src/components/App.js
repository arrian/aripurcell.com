	...
	<ScrollableAnchor id={'projects'}>
		<div style={{ backgroundColor: '#E6E2DF' }}>
			<Container text style={{ paddingTop: 20 }}>
				...
				<Grid>
					<Project title='Planet Search' labels={['web application', 'javascript', 'react', 'redux']} description='Developed a web application for searching astronomical objects.' image='/images/project-05.svg' link='https://arrianpurcell.com/planet-search' />
					...
					<Project title='Code Graph' labels={['web application', 'javascript']} description='Developed a source code analysis tool and a web interface for examining the links between source code modules.' image='/images/project-04.svg' link='https://arrianpurcell.com/code-graph' />
